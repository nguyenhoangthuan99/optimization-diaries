...
int main(int argc,char**argv){
    ...
    inst<64,128,32,32,8,8,4>("b32_8x4_ref",A,B,C,hRef.data(),M,N,K,it);
    inst<64,64,32,16,8,8,4>("b32_64x64_8x4",A,B,C,hRef.data(),M,N,K,it);
    inst<32,128,32,32,4,8,4>("b32_32x128_8x4",A,B,C,hRef.data(),M,N,K,it);
    inst<32,64,32,16,4,8,4>("b32_32x64_8x4",A,B,C,hRef.data(),M,N,K,it);
    inst<64,128,32,32,8,8,4>("b32_8x4_again",A,B,C,hRef.data(),M,N,K,it);
    return 0;
}
